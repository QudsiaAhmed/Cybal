...
const TrustCyberSecurityOperation = () => {
  ...
  return (
    <Box style={containerStyle}>
      <Box style={imageContainerStyle}>
        <img
          src="https://cybal-nextjs.vercel.app/assets/img/about2.png"
          alt="About"
          style={imageStyle}
        />
      </Box>
      <Box style={contentContainerStyle}>
        <Button sx={buttonStyle}>Trust your cyber companyy</Button>
        <Typography
          sx={{
            mt: 4,
            fontSize: "2rem",
        ...
        <Box sx={boxStyle}>
          ...
          >
            <CheckIcon sx={{ color: "#18FED5", mr: 1, ml: 2 }} />
            Security Services
          </Typography>
          <br />
        ...
        <Box sx={boxStyleTwo} style={{ marginTop: "3%" }}>
          ...
          >
            <CheckIcon sx={{ color: "#18FED5", mr: 1, ml: 2 }} /> Industry
            Certified
          </Typography>
          <br />
          <Typography sx={{ textAlign: "left", ml: 3 }}>
...
export default TrustCyberSecurityOperation;
